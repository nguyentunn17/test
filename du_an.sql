...
GO
select * from DongSP
insert into ChiTietSP (IdSP,IdMauSac,IdDongSP,NamBH,MoTa,SoLuongTon,GiaNhap,GiaBan) values ('0B57ACD3-1952-4A5F-BD75-672D8C7C330F','732F155B-9D7B-4E71-BA7F-C11D93A948C9','6FEC4244-09FD-4D7A-B3C1-AFF7363FFC56', '2022',null,12,55,70)
-- HoaDonChiTiet
...
insert into SanPham (Ma,Ten) values (1, 'Mu')